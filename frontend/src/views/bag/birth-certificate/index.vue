<template>
  <div class="birth-certificate-container">
    <table-layout class="table-layout">
      ...
      <template>
        ...
        >
          ...
          <el-table-column prop="content.birthTime" label="出生时间" align="center" width="160" />
    ...
    <birth-certificate-form-dialog ref="formDialog" v-model="dialogVisible" :form-id="formId" @save-success="handleRefresh" />
    <birth-certificate-form-dialog-view ref="formDialogView" v-model="dialogVisibleView" :form-id="formId" />
  </div>
</template>
...
import birthCertificateFormDialog from './components/birth-certificate-form-dialog'
import birthCertificateFormDialogView from './components/birth-certificate-form-dialog-view'
...
export default {
  ...
  components: {
    ...
    birthCertificateFormDialog,
    birthCertificateFormDialogView
  },
  data() {
    return {
      // 列表相关
