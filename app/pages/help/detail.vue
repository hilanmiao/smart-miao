<template>
  <view class="wrap">
    ...
    <view>
      <u-parse :html="content" :selectable="true" :lazy-load="true" :show-with-animation="true"></u-parse>
    </view>
  </view>
</template>
...
\t\t\t\t\t<p>　　“搬出去有盼头，留下来有干劲。”如今，乡里还在加紧研究制定金满村乡村旅游规划。“等客栈、农家乐、步行街都建好了，幸福一定来敲门。”洛本卓乡党委书记郝春荣说，巩固脱贫成果、走向乡村振兴，“好日子还在后头”。</p><!--repaste.body.end-->
  ...
  methods: {
    openPage(url = '/pages/help/index', type = 'to', params) {
      this.$u.route({
        url,
        type,
        params
